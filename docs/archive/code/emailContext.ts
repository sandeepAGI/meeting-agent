 ...
 *
 * DEPRECATION REASON:
 * After implementing and testing, we found that email context provided
 * no measurable value for speaker identification or meeting summarization.
 * LLMs prioritize transcript content over emails, and calendar attendee
 * lists create anchoring bias that emails cannot overcome.
 */
